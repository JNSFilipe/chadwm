...
static const char *light_down[] = {"/usr/bin/brightnessctl", "set", "5%-",
                                   NULL};
static const char *kbd_light_up[] = {
    "/usr/bin/brightnessctl", "-d", "'asus::kbd_backlight'", "set", "+1", NULL};
static const char *kbd_light_down[] = {
    "/usr/bin/brightnessctl", "-d", "'asus::kbd_backlight'", "set", "1-", NULL};
...
static const char *fonts[] = {"JetBrainsMono Nerd Font:style:medium:size=12",
                              "JetBrainsMono Nerd Font:style:medium:size=19"};
...
static const Rule rules[] = {
    ...
    {"mainterm", NULL, NULL, 1 << 0, 0, 0, -1},
    {"firefox", NULL, NULL, 1 << 1, 0, 0, -1},
    {"vimterm", NULL, NULL, 1 << 2, 0, 0, -1},
    {"github\ desktop", NULL, NULL, 1 << 3, 0, 0, -1},
    {"Opera", NULL, NULL, 1 << 4, 0, 0, -1},
...
static const Key keys[] = {
    ...
    {0,
     ...
     spawn,
     {.v = kbd_light_up}}, // TODO: Does not work
    {0,
     XF86XK_KbdBrightnessDown,
     spawn,
     {.v = kbd_light_down}}, // TODO: Does not work
